    ...
    def build_graph(self, M_0):
        ...
        with self.graph.as_default():
            ...
            with tf.name_scope('inputs'):
                ...
                self.ph_data    = tf.compat.v1.placeholder(dtype=tf.float32, shape=(self.batch_size, M_0), name='data')
                self.ph_labels  = tf.compat.v1.placeholder(dtype=tf.int32, shape=(self.batch_size),name= 'labels')
                self.ph_dropout = tf.compat.v1.placeholder(dtype=tf.float32, shape=(), name='dropout')
